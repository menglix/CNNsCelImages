# code for DeepYeast extraction followed by Random Forest
import numpy as np
...
rf_grid.fit(CNNFeatures,trainvalY)
rf_best_model = rf_grid.best_estimator_


# evaluate the test accuracy
testCNNFeatures=convertCNNfeature(X_test)
testAcc = evaluate(rf_best_model, testCNNFeatures, testlabel)

with open('/home/menglix/result/deepyeast/transferlearning/rf_best_params.pkl', 'wb') as f:
