...
# it corresponds to our straightened Res18 with off-the-shelf data augmentation method plus change to Adam optimizer
...
filepath="/space/data/deepyeastmodel/ResMaxinBw/20180401ResMaxweightsAdam.{epoch:02d}-{val_acc:.2f}.hdf5"
...
lr_reducer = ReduceLROnPlateau(factor=0.1, monitor='val_acc',cooldown=0, patience=5, min_lr=0.5e-6)
...
with open(output_dir+'/Augmentdyresnet18MaxAdam'+'.pkl', 'wb') as file_pi:
...
plt.savefig('/home/menglix/result/deepyeast/20180401dyRes18MaxaccuracyAdam.pdf')
plt.clf()
