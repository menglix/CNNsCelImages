...
# corresponding to our straightened Res50 with identity shortcuts
...
filepath="/space/data/deepyeastmodel/Res50MaxinBw/ResMaxweights.{epoch:02d}-{val_acc:.2f}.hdf5"
...
plt.savefig('/home/menglix/result/deepyeast/dyRes50Maxaccuracy.pdf')
plt.clf()
