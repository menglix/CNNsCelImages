...
# it corresponds to Res50 (He et al., 2016) 
...
filepath="/space/data/deepyeastmodel/ResMaxinBw/#2res50/ResMaxweights.{epoch:02d}-{val_acc:.4f}.hdf5"
output_dir = '/home/menglix/result/deepyeast/ResNet/Res50'
...
with open(output_dir+'/#2dyresnet50Max'+'.pkl', 'wb') as file_pi:
...
plt.savefig('/home/menglix/result/deepyeast/ResNet/Res50/#2dyRes50Maxaccuracy.pdf')
plt.clf()
