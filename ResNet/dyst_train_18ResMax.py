...
# corresponding to our straightened Res18 with identity shortcuts
...
filepath="/space/data/deepyeastmodel/ResMaxinBw/ResMaxweights(2).{epoch:02d}-{val_acc:.2f}.hdf5"
...
# save the model
checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, mode='auto',period=10)
...
with open(output_dir+'/dyresnet18Max'+'.pkl', 'wb') as file_pi:
            pickle.dump(history.history, file_pi)
	
    
# generate the accuracy vs. epoch plot during the training process
import matplotlib
matplotlib.use('agg')
...
plt.savefig('/home/menglix/result/deepyeast/dyRes18Maxaccuracy.pdf')
plt.clf()
