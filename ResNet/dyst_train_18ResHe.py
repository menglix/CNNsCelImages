...
# corresponding to Res18 in He et al. (2016)
...
filepath="/space/data/deepyeastmodel/Res18he/Res18he.{epoch:02d}-{val_acc:.2f}.hdf5"
output_dir = '/home/menglix/result/deepyeast/ResNet/ResNet18'
...
with open(output_dir+'/res18heAcc'+'.pkl', 'wb') as file_pi:
...
plt.savefig('/home/menglix/result/deepyeast/dyRes18Heaccuracy.pdf')
plt.clf()
