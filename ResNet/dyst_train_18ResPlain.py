...
# it corresponds to VGG-type CNN of our straightened Res18 with identity shortcuts 
...
filepath="/space/data/deepyeastmodel/Res18plainweights.{epoch:02d}-{val_acc:.4f}.hdf5"
...
with open(output_dir+'/dyresnetplain18'+'.pkl', 'wb') as file_pi:
...
plt.savefig('/home/menglix/result/deepyeast/dyRes18Plainaccuracy.pdf')
plt.clf()
