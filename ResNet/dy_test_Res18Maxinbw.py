# test code for VGG-type resnet model (green row in our table 4)
# Author: Mengli Xiao
...
# set the system image format
if K.image_data_format() == 'channels_first':
	input_shape = (3, img_width, img_height)
else:
	input_shape = (img_width, img_height, 3)

 # copy and paste the model specification from the train scripts--------------------------------------------------------
def relu(x):
...
model.load_weights("/space/data/deepyeastmodel/ResMaxinBw/ResMaxweights(2).289-0.87.hdf5")
